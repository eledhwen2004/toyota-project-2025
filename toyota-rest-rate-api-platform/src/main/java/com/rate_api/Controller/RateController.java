...
/**
 * REST controller for handling rate-related API requests.
 */
@RestController
@RequestMapping("/api")
public class RateController {
    ...
    /**
     * Retrieves rate information for the specified rate name.
     *
     * @param rate_name the name of the rate to retrieve.
     * @return a {@link RateDto} containing rate details.
     */
